...
public class UpSchoolApiTestTeacher extends BaseClass{
	...
	public void setUp() {
		...
		ReportName = "UpSchoolTeacher-" + formattedDate + "&" + formattedTime + ".html";
		//System.out.println("reportLocation: " + RafflouxReportLoginPath);
		ExtentHtmlReporter htmlReporter = new ExtentHtmlReporter(UpSchoolReportPath+"Teacher"+ReportName);
	...
	public void beforeMethod() {
		test = extent.createTest("UpSchool-Teacher API", "API Test");
	}
	
	
	
	@Test(priority = 1)
	public void RestApiLoginValidationsTeacher()

	{
		int ExpectedStatusCode = 200;
		String Payload = "{ \"data\" :{\r\n"
				+ "              \"user_email\": \"Aishwarya.Ravindra@rhibhus.com\",\r\n"
				+ "                    \"user_password\":\"Mica12345\"\r\n"
				+ "                  }\r\n"
				+ "}";
	//	String EndPoint = "/v1/signIn";
		...
		Response response = RestAssured
				...
				.post("https://173riv98n3.execute-api.ap-south-1.amazonaws.com/testing/v1/login")
	...
	@Test(priority=2,  dataProvider = "TeacherSheet", dataProviderClass = DataProviderExcelReader.class)

	public void UpschoolTeacherRestApiFuntValidations(String Rownum ,String APIFunctionName, String Method, String EndPoint, String Payload,
			double ExpectedStatusCodeDouble,String ExpectedResponseBody)


	{
		
		jwtToken="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ0ZWFjaGVyX2lkIjoiMmYxZWRlN2UtY2Q2ZS01ZmQyLTk4OTEtZDUyNDQ0NjE4NDNmIiwidXNlcl9yb2xlIjoiVGVhY2hlciIsInVzZXJfbmFtZSI6IkFpc2h3YXJ5YXIiLCJpYXQiOjE2OTE0MDQwMDF9.RcaYNFfGDZ4VL8ifwIkPS6s1-xI7WDIICPKwik6AxlM";
	    ...
	    // System.out.println(jwtToken1);
		 ...
		 Response response = RestAssured
				...
				.baseUri("https://173riv98n3.execute-api.ap-south-1.amazonaws.com/testing/")
...
//}
	...
	@Test(priority=3,  dataProvider = "TeacherSheet", dataProviderClass = DataProviderExcelReader.class)

	public void UpschoolTeacherInvalidJwt(String Rownum ,String APIFunctionName, String Method, String EndPoint, String Payload,
			double ExpectedStatusCodeDouble,String ExpectedResponseBody)
	{
	   ...
	   int ExpectedStatusCodeinvalidJWT=403;
