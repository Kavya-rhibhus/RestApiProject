...
public class CustomerApi extends BaseClass {
	...
	public void setUp() {
		...
		ExtentHtmlReporter htmlReporter = new ExtentHtmlReporter(SpryntzReportPath+"cust"+ReportName);
	...
	public void beforeMethod() { 
		test = extent.createTest("Spryntz Customer  API", "API Testing both Positive and negative");
	}
...
//		String EndPoint = "/v1/signIn";
	    ...
	    FleetOnboardingJwt = jsonObject.getJSONObject("data").getString("auth_token");
	    // Print the extracted auth_token
	    System.out.println("Auth Token:--------> " + FleetOnboardingJwt);
		...
		Reporter.log("Actual Response body" + " =>" + FleetOnboardingJwt + "=>" + "Expected Response Body is" + "=>" + RestaurantOnboardingJwt);
 ...
 @Test(priority=2,  dataProvider = "cust", dataProviderClass = DataProviderExcelReader.class)
...

	{
		 ...
		 Response response = RestAssured
				...
				.header("Authorization",FleetOnboardingJwt)
	...
	//@Test(priority=3,  dataProvider = "CustomerApi", dataProviderClass = DataProviderExcelReader.class)
			...
			double ExpectedStatusCodeDouble,String ExpectedResponseBody)
	{
		...
		String FleetOnboardingJwt="eyJ1c2VyX2lkIjoxNTEwNjMsInVzZXJfZW1haWwiOiJ2ZWVyYS5yYWdoYXZhbkByaGliaHVzLmNvbSIsInVzZXJfZmlyc3RfbmFtZSI6InZlZXJhIiwidXNlcl9sYXN0X25hbWUiOiJyYWdoYXZhbiIsImlhdCI6MTY4NTMzMjEwM30";
