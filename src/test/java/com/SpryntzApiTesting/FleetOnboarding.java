...
public class FleetOnboarding extends BaseClass {
	...
	public void setUp() {
		...
		ExtentHtmlReporter htmlReporter = new ExtentHtmlReporter(SpryntzReportPath+"Fleet"+ReportName);
	...
	public void beforeMethod() { 
		test = extent.createTest("Spryntz FleetOnboarding API", "API Testing both Positive and negative");
	}
...

	{
		...
		String Payload = "{\r\n"
				+ "    \"email\" : \"fleetwinseridersowner@gmail.com\",\r\n"
				+ "    \"password\" : \"WROwner@1\",\r\n"
				+ "    \"device_type\": \"ANDRIOD\",\r\n"
				+ "    \"device_token\": \"mobile\"\r\n"
				+ "}";
