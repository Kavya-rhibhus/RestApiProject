...
public class RestaurantOnboarding extends BaseClass {
...
//@Test(priority = 1)
	...
	//	String EndPoint = "/v1/signIn";
        ...
        System.out.println("Auth Token RestaurantOnboardingJwt:--------> " + RestaurantOnboardingJwt);
		...
		Reporter.log("Actual Response body" + " =>" + RestaurantOnboardingJwt + "=>" + "Expected Response Body is" + "=>" + RestaurantOnboardingJwt);
...

{
	 ...
	 Response response = RestAssured
			...
			.header("Authorization", RestaurantOnboardingJwt)
...
//----------------------------RestaurantOnboarding-invalid jwt-----------------------------------------------------------------
		...
		double ExpectedStatusCodeDouble,String ExpectedResponseBody)
{
	...
	String RestaurantOnboardingJwt="eyJ1c2VyX2lkIjoxNTEwNjMsInVzZXJfZW1haWwiOiJ2ZWVyYS5yYWdoYXZhbkByaGliaHVzLmNvbSIsInVzZXJfZmlyc3RfbmFtZSI6InZlZXJhIiwidXNlcl9sYXN0X25hbWUiOiJyYWdoYXZhbiIsImlhdCI6MTY4NTMzMjEwM30";
