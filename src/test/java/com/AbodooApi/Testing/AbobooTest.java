...
public class AbobooTest extends BaseClass{
	public ExtentReports extent;
	public ExtentTest test;
	public String AbodooJwt;
	...
	public void setUp() {
		...
		ReportName =  formattedDate + "&" + formattedTime + ".html";
		//System.out.println("reportLocation: " + RafflouxReportLoginPath);
		ExtentHtmlReporter htmlReporter = new ExtentHtmlReporter(AbodooReportPath+"employee"+ReportName);
	...
	public void beforeMethod() {
		test = extent.createTest("Abodoo API", "API Testing both Positive and negative");
	}
...
//@Test(priority = 1)
public void AbodooLoginValidationsChefOnboarding()  
...
//	String EndPoint = "/v1/signIn";
	...
	Response response = RestAssured
			...
			.post("https://ntxxwomcrl.execute-api.ap-south-1.amazonaws.com/dev")
    ...
    String  Aboboojwt1 = jsonObject.getJSONObject("data").getString("auth_token");
    // Print the extracted auth_token
    System.out.println("Auth Token:--------> " + Aboboojwt1);
	...
	//Reporter.log("Actual Response body" + " =>" + Aboboojwt1 + "=>" + "Expected Response Body is" + "=>" + a);
...
@Test(priority=1,  dataProvider = "Abodoo", dataProviderClass = DataProviderExcelReader.class)

public void AbodootestApi(String Rownum ,String APIFunctionName, String Method, String EndPoint, String Payload,
		double ExpectedStatusCodeDouble,String ExpectedResponseBody,	double ExpectedStatusCodeDouble1)

{
	
	 AbodooJwt ="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiJmYzZlMDIxNi1kMTJjLTQ1ODktOTZmNC1kYjQzNmExNGE3ZTgiLCJlbWFpbCI6InBldWhvbW11bml0cm91LTYxODBAeW9wbWFpbC5jb20iLCJmaXJzdE5hbWUiOiJhaXNod2FyeWEiLCJsYXN0TmFtZSI6IlJhdmluZHJhIiwidHlwZSI6MiwiaWF0IjoxNzA0Mjg0NzY1LCJleHAiOjE3MDQ0NTc1NjV9.wkm-0ql0YuLx2byuCEd73xGTFLAAlZLAK0KGh3pZTf0";
...
{ 
	 ...
	 Response response = RestAssured
			...
			.given().header("Authorization",AbodooJwt)
			.header("code", "d0a063").header("language", "1").header("currency", "AED")
			.contentType(ContentType.JSON).body(Payload).when().post("https://yha8avzzv3.execute-api.ap-south-1.amazonaws.com/testing/v1/"+EndPoint).then().extract()	.response();
...

{
 ...
 Response response = RestAssured
		...
		.header("Authorization",AbodooJwt)
...
@Test(priority=2,  dataProvider = "Abodoo", dataProviderClass = DataProviderExcelReader.class)

public void AbodootestApi1(String Rownum ,String APIFunctionName, String Method, String EndPoint, String Payload,
		double ExpectedStatusCodeDouble1,String ExpectedResponseBody,double ExpectedStatusCodeDouble)
...
{ 
	 ...
	 Response response = RestAssured
			...
			.given().header("Authorization",AbodooJwt)
			.header("code", "d0a063").header("language", "1").header("currency", "AED")
			.contentType(ContentType.JSON).body(Payload).when().post("https://ntxxwomcrl.execute-api.ap-south-1.amazonaws.com/dev/v1"+EndPoint).then().extract()	.response();
