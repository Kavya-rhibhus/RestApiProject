...
public class Abobooemployee extends BaseClass{
...

{
	...
	String Payload = "{\"email\": \"Vinod.nagaraj@rhibhus.com\", \"password\": \"Vinu8858@8\"}";
//	String EndPoint = "/v1/signIn";
	...
	Response response = RestAssured
			...
			.post("https://ntxxwomcrl.execute-api.ap-south-1.amazonaws.com/dev/v1/userLogin")
...

{
	 ...
	 AbodooJwt ="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiIyYzY2ZGFiMS1jYzliLTRkMjEtYjE5Yi02ZTIxNjdlZWRlN2UiLCJlbWFpbCI6ImFpc2h3YXJ5YS5yYXZpbmRyYUByaGliaHVzLmNvbSIsImZpcnN0TmFtZSI6IkFpc2h3YXJ5YSAiLCJsYXN0TmFtZSI6IlJhdmluZHJhICIsInR5cGUiOjIsImlhdCI6MTcwMzY1MjM5NywiZXhwIjoxNzAzODI1MTk3fQ.4PjiPyMNDwqiXfeRmx3qzUwmTQb-qaiet3k2w2PmfpE";
...
//@Test(priority=3,  dataProvider = "Abodoo", dataProviderClass = DataProviderExcelReader.class)
