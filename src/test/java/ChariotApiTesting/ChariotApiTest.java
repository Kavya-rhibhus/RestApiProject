...
public class ChariotApiTest extends BaseClass{
	...
	public void setUp() {
		...
		System.out.println("reportLocation ReportName: " + ChariotReportPath+ ReportName);
	...
	public void beforeMethod() {
		test = extent.createTest("Chariot API's", "API Testing");
	}
...

	{
...

		{
		 ...
		 Response response = RestAssured
				...
				.baseUri("https://zm73c0uyjl.execute-api.ap-south-1.amazonaws.com/testing")
