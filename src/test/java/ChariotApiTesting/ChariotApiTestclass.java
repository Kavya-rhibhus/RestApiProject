...
public class ChariotApiTestclass extends BaseClass{
	public ExtentReports extent;
	public ExtentTest test;
	
	public String jwtToken;
	
	public String baseurl ="https://zm73c0uyjl.execute-api.ap-south-1.amazonaws.com/testing";
	...
	public void setUp() {
		...
		ReportName = "Chariot-" + formattedDate + "&" + formattedTime + ".html";
		System.out.println("reportLocation: " + ChariotReportPath+ ReportName);
		ExtentHtmlReporter htmlReporter = new ExtentHtmlReporter(ChariotReportPath+ ReportName);
	...
	public void beforeMethod() {
		test = extent.createTest("Chariot Rest API", "API Testing both Positive and negative");
	}
	...
	@Test(priority=2,  dataProvider = "chariot", dataProviderClass = ChariotApiTesting.DataProviderExcelReader.class)

	public void ChariotRestApiFuntValidations(String Rownum ,String APIFunctionName, String Method, String EndPoint, String Payload,
			double ExpectedStatusCodeDouble,String ExpectedResponseBody)


	{
		
		jwtToken="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiIyIiwiZW1haWwiOiJrYXZ5YS5rcmlzaG5hbXVydGh5QHJoaWJodXMuY29tIiwiZnVsbE5hbWUiOiJLYXZ5YSBLIiwiaWF0IjoxNzA5NjMyNTkwLCJleHAiOjE3MDk4MDUzOTB9.lmgOU5ZIwHtDv5T0Euon-UgpHySG8bsd8HkROwzRLLs";
