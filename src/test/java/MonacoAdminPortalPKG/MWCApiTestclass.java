...
public class MWCApiTestclass extends BaseClass{
	public ExtentReports extent;
	public ExtentTest test;
	
	public String jwtToken;
	
	public String baseurl ="https://g669q1e8se.execute-api.ap-south-2.amazonaws.com/testing";
	...
	public void beforeMethod() {
		test = extent.createTest("MWC Admin Portal Rest API", "API Testing both Positive and negative");
	}
	...
	@Test(priority=2,  dataProvider = "MWC", dataProviderClass = MonacoAdminPortalPKG.DataProviderExcelReaderMWc.class)

	public void MWCAdminRestApiTest(String Rownum ,String APIFunctionName, String Method, String EndPoint, String Payload,
			double ExpectedStatusCodeDouble,String ExpectedResponseBody)


	{
		
		jwtToken="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJyZXF1ZXN0Ijp7InVzZXJfaWQiOiJVc2VyIzM0NGRjOWRiLTJjNDEtNGE5Yy04ZDBjLTNhNDU2NjJkZGExZCIsInVzZXJfZW1haWwiOiJ0ZXN0NjZAZ21haWwuY29tIiwidXNlcl9maXJzdF9uYW1lIjoidGVzdCIsInVzZXJfbGFzdF9uYW1lIjoiNDYiLCJpc1NvY2lhbE1lZGlhIjp0cnVlfSwiaWF0IjoxNzE0OTcyNTc3fQ.dIHQSLCQmJNrfUFx-lf-npbdCrpSS-MdCBiLgraHekE";
